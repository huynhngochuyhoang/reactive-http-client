...
FINAL_EVIDENCE_ROOT="$ROOT_DIR/target/release-evidence/v23-priority11/matrix"
...
[[ "$PROJECT_VERSION" == "3.4.0-SNAPSHOT" ]] \
  || fail "expected current development version 3.4.0-SNAPSHOT, found $PROJECT_VERSION"
[[ "$BASELINE_VERSION" == "3.3.0" ]] \
  || fail "expected published API baseline 3.3.0, found $BASELINE_VERSION"
