...
[[ "$PROJECT_VERSION" == "3.2.0-SNAPSHOT" ]] \
  || fail "expected current development version 3.2.0-SNAPSHOT, found $PROJECT_VERSION"
[[ "$BASELINE_VERSION" == "3.1.0" ]] \
  || fail "expected published API baseline 3.1.0, found $BASELINE_VERSION"
