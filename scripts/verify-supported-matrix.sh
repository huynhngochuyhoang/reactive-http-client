...
[[ "$PROJECT_VERSION" == "4.2.0-SNAPSHOT" ]] \
  || fail "expected current development version 4.2.0-SNAPSHOT, found $PROJECT_VERSION"
[[ "$BASELINE_VERSION" == "4.1.0" ]] \
  || fail "expected published API baseline 4.1.0, found $BASELINE_VERSION"
