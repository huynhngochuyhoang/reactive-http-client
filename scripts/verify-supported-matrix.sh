...
[[ "$PROJECT_VERSION" == "4.5.0-SNAPSHOT" ]] \
  || fail "expected current development version 4.5.0-SNAPSHOT, found $PROJECT_VERSION"
[[ "$BASELINE_VERSION" == "4.4.0" ]] \
  || fail "expected published API baseline 4.4.0, found $BASELINE_VERSION"
