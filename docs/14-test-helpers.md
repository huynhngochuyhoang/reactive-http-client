...
The weighted overload and retained-byte snapshot field are unpublished
`4.2.0`/V29 release-candidate APIs; published `4.1.x` test helpers expose the count-only
