...
| `reactive.http.clients.[name].compression-enabled` | `java.lang.Boolean` | `false` | Enable Reactor Netty response compression negotiation and decompression (Accept-Encoding: gzip). Request bodies are not compressed. Default: false. |  |
